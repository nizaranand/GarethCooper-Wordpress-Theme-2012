		...
		<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			<header class="entry-header">
				...
				<div class="entry-meta">
					...
					printf( __( 'Published <span class="entry-date"><abbr class="published" title="%1$s">%2$s</abbr></span> at <a href="%3$s" title="Link to full-size image">%4$s &times; %5$s</a> in <a href="%6$s" title="Return to %7$s" rel="gallery">%7$s</a>', 'garethcooper' ),
			...
			<div class="entry-content">
				...
				<p>Published on: <time style="background:none;padding:0;" datetime="<?php echo get_the_date( 'c' ); ?>"><?php echo get_the_date(); ?></time>
				Taken On: <?php echo $metadata['image_meta']['created_timestamp']; ?>
				Aperture: f/<?php echo $metadata['image_meta']['aperture']; ?>
				Shutter speed: <?php
				...
				ISO: <?php echo $metadata['image_meta']['iso']; ?>
				Focal Length: <?php echo $metadata['image_meta']['focal_length']; ?>mm
				Camera: <?php echo $metadata['image_meta']['camera']; ?></p>
