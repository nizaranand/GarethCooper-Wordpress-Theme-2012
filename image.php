				...
				<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
					<header class="entry-header">
						...
						<nav id="image-navigation">
							<span class="previous-image"><?php previous_image_link( false, __( '&larr; Previous' , 'garethcooper' ) ); ?></span>
							<span class="next-image"><?php next_image_link( false, __( 'Next &rarr;' , 'garethcooper' ) ); ?></span>
					...
					<footer class="entry-meta">
						...
						<?php endif; ?>
						<?php edit_post_link( __( 'Edit', 'garethcooper' ), ' <span class="edit-link">', '</span>' ); ?>
					</footer><!-- .entry-meta -->
